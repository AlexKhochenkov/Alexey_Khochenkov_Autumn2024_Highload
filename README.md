...
Так же для эффективного поиска пользователей для приглашения в событие былоо решено добавить таблицу Elstic_Search, которая будет отвечать за эффективный поиск по пользователям с помощью СУБД Elasticsearch.
